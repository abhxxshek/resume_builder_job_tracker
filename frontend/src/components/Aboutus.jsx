...
const teamMembers = [
  ...
  { name: 'Aksa S Santhosh', role: 'QA Tester', img: 'src/components/images/aksaaaa.jpg' },
  // { name: 'Anup Muthali Anil', role: 'UI/UX Designer', img: '/images/michael.jpg' },
  { name: 'Gokul Santhosh', role: 'Content Developer', img: 'src/components/images/batman.jpg' }
